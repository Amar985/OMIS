...
namespace OnlineMusicStore.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
                ...
                foreach(var item in ShoppingCartVM.ShoppingCartList)
                {
                    var sessionLineItem = new SessionLineItemOptions
                    {
                        PriceData = new SessionLineItemPriceDataOptions
                        {
                            ...
                            {
                                Name = item.Product.InstrumentName
                            }
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            {
                var service = new SessionService(); //stripe method
        ...
        {
            return Math.Round(shoppingcart.Product.price,2);
        }
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            {
                HttpContext.Session.SetInt32(SD.SesionCart, _unitOfWork.ShoppingCart
